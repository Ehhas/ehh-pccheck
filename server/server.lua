    ...
    if Players[id] then
        if Config.IsAutoBan then
            if Config.BanType == 'fg' then
                ...
                SendToDiscord('Pc Check ban', '**Player:** '..(id or "Unknown")..'\n **name:** '..(GetPlayerName(id) or "Unknown")..'\n **License of the one that got banned:** '..(string.gsub(GetPlayerIdentifierByType(id, "license") or "", "license:", "") or "Unknown")..'\n **Discord Id of the one that got banned:** '..(string.gsub(GetPlayerIdentifierByType(id, "discord") or "", "discord:", "") or "Unknown")..'\n **Who was pc checking:** '..(AdminId or "Unknown")..'\n **Who was pc checking name:** '..(GetPlayerName(AdminId) or "Unknown")..'\n **License of the one who was pc checking:** '..(string.gsub(GetPlayerIdentifierByType(AdminId, "license") or "", "license:", "") or "Unknown")..'\n **Discord Id of the one that was pc checking:** '..(string.gsub(GetPlayerIdentifierByType(AdminId, "discord") or "", "discord:", "") or "Unknown"), 16711680)
            ...
            elseif Config.BanType == 'EA' then
                Players[id] = nil
                TriggerEvent("EasyAdmin:addBan", id, 'This player left while getting pc checked', 0, GetPlayerName(AdminId))
                SendToDiscord('Pc Check ban', '**Player:** '..(id or "Unknown")..'\n **name:** '..(GetPlayerName(id) or "Unknown")..'\n **License of the one that got banned:** '..(string.gsub(GetPlayerIdentifierByType(id, "license") or "", "license:", "") or "Unknown")..'\n **Discord Id of the one that got banned:** '..(string.gsub(GetPlayerIdentifierByType(id, "discord") or "", "discord:", "") or "Unknown")..'\n **Who was pc checking:** '..(AdminId or "Unknown")..'\n **Who was pc checking name:** '..(GetPlayerName(AdminId) or "Unknown")..'\n **License of the one who was pc checking:** '..(string.gsub(GetPlayerIdentifierByType(AdminId, "license") or "", "license:", "") or "Unknown")..'\n **Discord Id of the one that was pc checking:** '..(string.gsub(GetPlayerIdentifierByType(AdminId, "discord") or "", "discord:", "") or "Unknown"), 16711680)
            elseif Config.BanType.uppercase == "WX" then
                exports["wx_anticheat"]:ban(id, 'This player left while getting pc checked')
                SendToDiscord('Pc Check ban', '**Player:** '..(id or "Unknown")..'\n **name:** '..(GetPlayerName(id) or "Unknown")..'\n **License of the one that got banned:** '..(string.gsub(GetPlayerIdentifierByType(id, "license") or "", "license:", "") or "Unknown")..'\n **Discord Id of the one that got banned:** '..(string.gsub(GetPlayerIdentifierByType(id, "discord") or "", "discord:", "") or "Unknown")..'\n **Who was pc checking:** '..(AdminId or "Unknown")..'\n **Who was pc checking name:** '..(GetPlayerName(AdminId) or "Unknown")..'\n **License of the one who was pc checking:** '..(string.gsub(GetPlayerIdentifierByType(AdminId, "license") or "", "license:", "") or "Unknown")..'\n **Discord Id of the one that was pc checking:** '..(string.gsub(GetPlayerIdentifierByType(AdminId, "discord") or "", "discord:", "") or "Unknown"), 16711680)
            else end
        else end
    end
